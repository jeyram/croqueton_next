        ...
        <div className="top-0 flex flex-col items-start space-y-4 lg:max-w-[40%] text-text px-0 py-6 lg:px-6 lg:text-white lg:border border-text lg:bg-black/40">
          ...
          {block.field_content_link && (
            <Link
              ...
              passHref
            >
              <a className="sm:whitespace-nowrap px-6 py-3 font-serif text-xl text-white transition-colors border-2 rounded-md bg-secondary hover:bg-white hover:text-black border-secondary">
